...
# CREATE A FUNCTION FOR THE SCALE LEGEND
Scalelegend = function(pnts,cols=heat.colors(100),limits=c(0,1), title='Legend', cex=2){
...
Scalelegend(pnts,colormap,c("Low","High"))
