...
Colormap= function(sdm.asc, threshold, bkgd.col = 'grey',cols=heat.colors(100)){
    #get range of data
    ...
    #add the scale bar
    Scalelegend(pnts,cols=c(bkgd.col,cols))
...
Colormap(tasc,0.08,bkgd.col = 'darkgrey', Scalebar=(x= 145.101, y=-19535, distance=20))
